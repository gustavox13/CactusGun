...
// one of the existing Survival Shooter scripts.
    ...
    private GameObject DC;
        ...
        {
            Debug.Log(string.Format("ProcessPurchase: PASS. Product: '{0}'", args.purchasedProduct.definition.id));
            DC.gameObject.GetComponent<StoreController>().BuyMoneyMin();
            // TODO: The subscription item has been successfully purchased, grant this to the player.
        }
        // Or ... an unknown product has been purchased by this user. Fill in additional products here....
        else if (String.Equals(args.purchasedProduct.definition.id, "coins700", StringComparison.Ordinal))
        {
            Debug.Log(string.Format("ProcessPurchase: PASS. Product: '{0}'", args.purchasedProduct.definition.id));
            // TODO: The subscription item has been successfully purchased, grant this to the player.
            DC.gameObject.GetComponent<StoreController>().BuyMoneyMed();
        }
        // Or ... an unknown product has been purchased by this user. Fill in additional products here....
        else if (String.Equals(args.purchasedProduct.definition.id, "coins2000", StringComparison.Ordinal))
        {
            Debug.Log(string.Format("ProcessPurchase: PASS. Product: '{0}'", args.purchasedProduct.definition.id));
            DC.gameObject.GetComponent<StoreController>().BuyMoneyMax();
            // TODO: The subscription item has been successfully purchased, grant this to the player.
        }
        // Or ... an unknown product has been purchased by this user. Fill in additional products here....
